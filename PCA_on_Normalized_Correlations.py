...
# The PCA function is going to require a matrix with samples as rows and features as columns. The next few steps create 
...
projected_train = pca.transform(pca_matrix[0:153,:])
projected_unknown = pca.transform(pca_matrix[153:205,:])
